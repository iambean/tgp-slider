...
!function (window, undefined) {
    ...
    function _init(slider) {
        ...
        bindEvent(itemElements, 'click', 'a', function (e) {
            ...
            var indexes = a.dataset['indexes'].split('-'),
                totalIndex = indexes[0] * 1,
                //item第一层
            item = indexes.length === 1 ? slider.options.items[totalIndex] : slider.options.items[totalIndex][indexes[1] * 1];
